...
public class DetectCatcher : MonoBehaviour
{
    ...
    // HAPUS "playerCollider"
    // private CapsuleCollider2D playerCollider; 
    
    // TAMBAHKAN INI
    public Transform[] checkPoints; // Kita akan isi ini di Inspector
    ...
    void Start()
    {
        ...
        {
            Debug.LogWarning("Warning: Tidak ada 'checkPoints' yang di-assign di DetectCatcher!");
        }
    }
    ...
    bool IsCaughtBy(Collider2D catcherCollider)
    {
        ...
        // --- LOGIKA BARU ---
        foreach (Transform pointTransform in checkPoints)
        {
            Vector2 worldPoint = pointTransform.position; // Langsung dapat world position
    ...
    void CheckIfFullyHidden()
    {
        ...
        foreach (Transform pointTransform in checkPoints)
        {
            Vector2 worldPoint = pointTransform.position;
